...
// function toCandlestickData(candles, tzOffsetSeconds = IST_OFFSET_SECONDS) {
//   return (candles || [])
//     .filter((c) => c && c.timestamp)
//     .map((c) => ({
//       // lightweight-charts expects UTC timestamps; shift them to display IST
//       time: isoToUtcSeconds(c.timestamp) + tzOffsetSeconds,
//       open: Number(c.open),
//       high: Number(c.high),
//       low: Number(c.low),
...
//   candles = [],
//   height = 520,
//   // set to 0 if you want to keep UTC display
//   tzOffsetSeconds = IST_OFFSET_SECONDS,
// }) {
...
//   const data = useMemo(
//     () => toCandlestickData(candles, tzOffsetSeconds),
//     [candles, tzOffsetSeconds]
//   );
